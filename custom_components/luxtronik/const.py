...
class LuxParameter(StrEnum):
    ...
    P0012_HEATING_CURVE_PARALLEL_SHIFT_TEMPERATURE = (
    ...
    P0089_HEATING_MAX_FLOW_OUT_INCREASE_TEMPERATURE = (
    ...
    P0111_HEATING_NIGHT_LOWERING_TO_TEMPERATURE = (
        "parameters.ID_Einst_TAbsMin_akt"
    )
    P0122_SOLAR_PUMP_ON_DIFFERENCE_TEMPERATURE = (
        "parameters.ID_Einst_TDC_Ein_akt"
    )
    P0123_SOLAR_PUMP_OFF_DIFFERENCE_TEMPERATURE = (
    ...
    P0867_EFFICIENCY_PUMP_NOMINAL = (
        "parameters.ID_Einst_Effizienzpumpe_Nominal_akt"
    )
    P0868_EFFICIENCY_PUMP_MINIMAL = (
    ...
    P0883_SOLAR_PUMP_MAX_TEMPERATURE_COLLECTOR = (
    ...
    P0992_RELEASE_TIME_SECOND_HEAT_GENERATOR = (
    ...
    P1059_ADDITIONAL_HEAT_GENERATOR_AMOUNT_COUNTER = (
...
class LuxCalculation(StrEnum):
    ...
    C0013_FLOW_OUT_TEMPERATURE_EXTERNAL = (
    ...
    C0022_FLOW_IN_CIRCUIT2_TARGET_TEMPERATURE = (
        "calculations.ID_WEB_Sollwert_TVL_MK2"
    )
    C0023_FLOW_IN_CIRCUIT3_TARGET_TEMPERATURE = (
    ...
    C0175_SUCTION_EVAPORATOR_TEMPERATURE = (
        "calculations.ID_WEB_LIN_ANSAUG_VERDAMPFER"
    )
    C0176_SUCTION_COMPRESSOR_TEMPERATURE = (
...
class LuxVisibility(StrEnum):
    ...
    V0105_HEAT_SOURCE_INPUT_TEMPERATURE_MIN = (
    ...
    V0239_EFFICIENCY_PUMP_NOMINAL = (
        "visibilities.ID_Visi_SysEin_EffizienzpumpeNom"
    )
    V0240_EFFICIENCY_PUMP_MINIMAL = (
    ...
    V0289_SUCTION_COMPRESSOR_TEMPERATURE = (
    ...
    V0310_SUCTION_EVAPORATOR_TEMPERATURE = (
    ...
    V0357_ELECTRICAL_POWER_LIMITATION_SWITCH = (
