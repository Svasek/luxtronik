...
class LuxtronikSensorEntity(LuxtronikEntity[LuxtronikSensorDescription], SensorEntity):  # type: ignore
...
class LuxtronikIndexSensor(LuxtronikSensorEntity):
    ...
    entity_description: LuxtronikIndexSensorDescription  # type: ignore
